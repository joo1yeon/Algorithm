...
- split()을 사용하는 경우 공백이 여러 개 올 때 처리가 어려웠음
- StringTokenizer 의 3가지 매개변수를 이용 (문자열, 구분자, 구분자를 토큰으로 사용할지 여부)
- 구분자 자체도 토큰으로 인식하게 하면 굳이 공백을 추가해줄 필요 없음
